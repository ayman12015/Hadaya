...
class Login extends BaseController
{
    ...
    public function noaccess() {
        ...
        $this->global['pageTitle'] = 'gift : no access';
        $this->datas();
    ...
    public function loginMe()
    {
        ...
        else
        {
            ...
            {
                $this->session->set_flashdata('error', 'بريد الكتروني غير صحيح');
    ...
    function resetPasswordUser()
    {
        ...
        else 
        {
            ...
            if($this->login_model->checkEmailExist($email))
            {
                ...
                {
                    $status = 'unable';
                    setFlashData($status, "حدث خطأ أثناء إرسال معلوماتك ، أعد المحاولة.");
                }
            }
            else
            {
                $status = 'invalid';
                setFlashData($status, "عنوان بريدك الإلكتروني غير مسجل.");
            }
