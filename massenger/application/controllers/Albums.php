...
class Albums extends CI_Controller {
	...
	public function album($param='null',$id='null') {
        ...
        if( $this->input->post('process') == 'true' ) {
            if($this->Mgallery->Save()) {
            	echo "<p >شكرا لك لقد تمت عمليه التسجيل بنجاح سوف نتواصل معك قريبا</p>";
	...
	public function do_upload() {
        $upload_path_url = "http://172.81.117.16/~appsejraay/Hadaya/massenger/uploads/gallery/" . 'uploads/gallery/';
